<template>
  <nav
    className="w-[100%] bg-[var(--app-navbar-color)] shadow-sm border-gray-200 px-6 py-3 flex items-start"
  >
    <div
      className="px-0 flex flex-wrap items-center justify-between w-[100%] my-auto"
    >
      <div className="flex my-auto">
        <span @click="ontoggle" className="cursor-pointer">
          <v-icon
            name="fa-bars"
            className="text-[var(--app-base-color)] cursor-pointer mt-2"
          >
          </v-icon>
        </span>
        <div className="text-[#000000b6] font-bold flex ml-2">
        ...
        <div className="relative m-auto py-2 px-2">
          ...
          <div className="w-[10px] h-[10px] absolute top-0 right-0">
            <span className="flex h-3 w-3">
              <span
                className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[var(--app-base-color)] opacity-75"
              ></span>
              <span
                className="relative inline-flex rounded-full h-3 w-3 bg-[var(--app-base-color)]"
              ></span>
            </span>
          </div>
        </div>
